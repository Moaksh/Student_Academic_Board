...
const data = [
    {title: "What is the role of the Student Academic Board?", des: "The role of the Student Academic Board is to represent and advocate for the interests of students, organize events, address concerns, and enhance the overall student experience within the departments."},
    {title: "What student organizations are affiliated under the Student Academic Board?", des: "In the Computer Science and Engineering (CSE) department, all the clubs and committees  related to Academics are under the Student Academic Board. Some of the affiliated student organizations may include the Computer Society of India (CSI), Association for Computing Machinery (ACM), and many more. These clubs and chapters play a vital role in promoting technical skills, organizing workshops, and fostering a sense of community among CSE students."},
