...
const data = [
    ...
    {title: "What initiatives or events does the Student Academic Board organize throughout the year?", des: "The CSE student cabinet organizes events like Zenevia, Specialization Day for 1st years, Hackathons, workshops, and guest lectures to enrich their academic and social experience throughout the year."},
