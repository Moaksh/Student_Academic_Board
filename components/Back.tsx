const Back = () => {
    return (
        ...
        <div>
            <svg viewBox="0 0 100 100" preserveAspectRatio="xMidYMid slice" id="bg-wrap" className={"brightness-75 "}>
                <defs>
                ...
                <rect x="0" y="0" width="100%" height="100%" fill="url(#Gradient6)">
                    ...
                    <animateTransform attributeName="transform" type="rotate" from="360 50 50" to="0 50 50" dur="17s" repeatCount="indefinite"/>
                </rect>
